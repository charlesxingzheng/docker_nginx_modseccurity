...
RUN sed -i 's/dl-cdn.alpinelinux.org/mirrors.aliyun.com/g' /etc/apk/repositories \
	...
	# forward request and error logs to docker log collector
        && sed -i '/^# *setvar:tx.paranoia_level=1"/a\SecAction "id:900000,phase:1,nolog,pass,t:none,setvar:tx.paranoia_level=2"' /etc/nginx/modsec.d/owasp-modsecurity-crs/crs-setup.conf \
